...
head(station_med[order(station_med$USAFID)])
```
...
# 3. Fin the closest station to mid-point of state
...
summary_table <- met |>
  ...
  pivot_wider(names_from = avg_temp_level, values_from = temp_mean)
summary_table
```
...
# bs = "cr" cubic regression line, 20 degree of fredom
